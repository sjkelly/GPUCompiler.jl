...
get_interpreter(@nospecialize(job::CompilerJob)) =
    GPUInterpreter(job.world; method_table_view=maybe_cached(method_table_view(job, world)),
...
method_table_view(@nospecialize(job::CompilerJob), world) = get_method_table_view(world, method_table(job))
